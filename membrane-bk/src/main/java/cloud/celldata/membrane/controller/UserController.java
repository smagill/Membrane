...
import cloud.celldata.membrane.pojo.bean.ForgetPassWordBean;
import cloud.celldata.membrane.pojo.bean.ResetPasswordBean;
import cloud.celldata.membrane.pojo.bean.ResponseBean;
import cloud.celldata.membrane.pojo.bean.UserBean;
...
public class UserController extends BaseController{
    ...
    public ResponseBean updateUser(@RequestBody UserVO userVO) {
            ...
            }else if (userVO.getFlag().getCode() ==1){
                //改变用户状态
                UserStatusEnum userStatus = UserStatusEnum.getStatusByCode(userVO.getStatus().getCode());
                try {
                    userManagementService.updateUserStatus(userVO.getId(), userVO.getStatus().getCode(), userId);
//                    if (null != userStatus) {
//                        switch (userStatus) {
//                            case ACTIVE:
//                                msg = ResponseCode.ENABLE_USER_SUCCESS_MSG;
//                                break;
//                            case NEGATIVE:
//                                msg = ResponseCode.DISABLE_USER_SUCCESS_MSG;
//                                break;
//                        }
//                    }
                } catch (Exception e) {
                    logger.error("编辑用户出错");
                    code = ResponseCode.GENERIC_FAILURE;
//                    if (null != userStatus) {
//                        switch (userStatus) {
//                            case ACTIVE:
//                                msg = ResponseCode.ENABLE_USER_FAILURE_MSG;
//                                break;
//                            case NEGATIVE:
//                                msg = ResponseCode.DISABLE_USER_FAILURE_MSG;
//                                break;
//                            default:
//                                msg = ResponseCode.UPDATE_FAILURE_MSG;
//                                break;
//                        }
//                    }
                }
